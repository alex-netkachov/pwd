...
private static bool Assert(bool value, string message = "") =>
...
private static void TestEncryptDecryptRoundup()
{
...
private static void TestDecryptingOpensslEncryptedData()
{
...
private static void TestOpensslDecryptingEncryptedData()
{
